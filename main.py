        ...
        if response.status_code == 200:
            try:
                ...
                if isinstance(data, list):
                    ...
                    message = f"Successfully retrieved {tweet_count} tweets for user @{request.username}"
                    ...
                    message = f"Successfully retrieved data for user @{request.username}"
